...
#      maxnoisepreds=10:16, polydegree=4, hrfShifts = 25, verbose=T )
    hrf<-ts( hemodynamicRF( 20, onsets=2, durations=1, rt=0.5,cc=0.1,a1=8,a2=16,b1=0.6, b2=0.6 ) )
    betas<-bold2betas( boldmatrix=imat[1:200,], 
      designmatrix=dmats[1:200,], baseshift=0, verbose=T,
      blockNumb=dmat$blockNumb[1:200], maxnoisepreds=4, hrfBasis=20,
