...
assembly2<-assembleBlocksToBetas( bmask, aalimg, labs, datadir, 
  imagepostfix,  dfn, afn, dmat, usedesignrow, hrf, ncompcor=ncompcor,
...
th<-0.5
ff<-( abs(zze) > th )
mydf<-data.frame( lab=mylabs,  vox=data.matrix(betas)[,ff], runs=as.factor(betadesign$blockNumb)  )
