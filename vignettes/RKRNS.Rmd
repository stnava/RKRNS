...
imatf<-filterfMRI4KRNS( imat, tr=tr, responselength=responselength, 
   ...
   removeEventOverlap=eventoverlap, removeSentLengthEffects=nschar )
```
...
ccaresults<-sccanBasedDecoder( eventdata, dmats, ccafeatspace , sentspaceSim, mysparse = c(-0.05, -0.1 ), nvecs=4, cthresh=100, doEanat=F, mask=mask4d, smooth=0.1 , its=1 )
# compare to
...
CCA-SVM results `r ccaresult$ccaresult`.  The SVD-SVM uses the SVD of the matrix
$X$ as predictors.
