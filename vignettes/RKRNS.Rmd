...
srcfiles<-paste("demo/",c("setup.R","assembleDesign.R","assembleBlocks.R","organizeDesign.R","boldbasedSentenceMap.R","basicValidation.R"))
for ( f in srcfiles ) source(system.file("demo/setup.R", package="RKRNS"))
% 
```
## BOLD Mechanics
