...
ccaresults<-sccanBasedDecoder( eventdata[ssubset,], dmats, ccafeatspace[ssubset,] , sentspaceSim[ssubset,], mysparse = c( -0.05, -0.05 ), nvecs=5, cthresh=50, doEanat=F, mask=mask4d, smooth=0.0 , its=5 )
vislist<-list()
for ( k in 1:2 ) {
