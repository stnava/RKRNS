...
TR<-0.5 
rootdir<-"demo/"
srcfiles<-paste(rootdir,c("setup.R","assembleDesign.R","assembleBlocks.R","organizeDesign.R"),sep='')
...
source( system.file( paste(rootdir,"boldbasedSentenceMap.R",sep=''), package="RKRNS") )
source( system.file( paste(rootdir,"basicValidation.R",sep='')     , package="RKRNS") )
blocklength<-450*TR
throwaway<-8
