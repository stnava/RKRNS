...
TR<-0.5 
srcfiles<-paste("demo/",c("setup.R","assembleDesign.R","assembleBlocks.R","organizeDesign.R"),sep='')
for ( f in srcfiles ) source(system.file(f, package="RKRNS"))
eigsent<-eigenSentences()
imatf<-filterfMRI4KRNS( imat )
source( system.file( "demo/boldbasedSentenceMap.R", package="RKRNS") )
source( system.file( "demo/basicValidation.R"     , package="RKRNS") )
blocklength<-450*TR
throwaway<-8
