...
```{r assembleimageblocks,echo=TRUE}
...
imatf<-filterfMRI4KRNS( imat, tr=tr, responselength=responselength, 
   removeEventOverlap=removeEventOverlap,removeSentLengthEffects=removeSentLengthEffects )
