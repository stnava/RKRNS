...
ccaresults<-sccanBasedDecoder( eventdata[,], dmats, ccafeatspace[,] , sentspaceSim[,], mysparse = c( -0.01, -0.9 ), nvecs=5, cthresh=0, doEanat=F, mask=mask4d, smooth=0.0 , its=11,  interleave=T ,  locwordlist=c('judge','blue') )
