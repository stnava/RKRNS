...
ccaresults<-sccanBasedDecoder( eventdata[,], dmats, ccafeatspace[,] , sentspace[,], mysparse = c( 0.05, 1/20 ), nvecs=20, cthresh=250, doEanat=F, mask=mask4d, smooth=0.1 , its=1,  interleave=T ,  locwordlist=c('coffee','dog','bird','lake','mountain' ) )
