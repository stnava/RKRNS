...
ssubset<-( grep( "judge", eventdata$sentences ) )
ccaresults<-sccanBasedDecoder( eventdata[ssubset,], dmats, ccafeatspace[ssubset,] , sentspaceSim[ssubset,], mysparse = c( -0.05, -0.05 ), nvecs=12, cthresh=0, doEanat=F, mask=mask4d, smooth=0.0 , its=15 )
vislist<-list()
