...
eigsent<-eigenSentences( wiki_words, normalize=T, functiontoapply = "svd" )
...
ccaresults<-sccanBasedDecoder( eventdata[,], dmats, ccafeatspace[,] , sentspace[,], mysparse = c( 0.01, 1/20 ), nvecs=20, cthresh=250, doEanat=F, mask=mask4d, smooth=0.1 , its=1,  interleave=T ,  locwordlist=c('coffee','dog','bird','lake','mountain' ) )
...
plotANTsImage( ref, vislist, slices='12x56x2' , thresh='0.05x1', color=rainbow( length(vislist) ) )
# compare to
